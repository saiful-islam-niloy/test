...
export default class TopCardContent extends Component {
    ...
    componentDidMount() {
        console.log("Inside HomePage: "+this.props)
    }
                        ...
                        <Col sm={12} md={12} lg={12}>
                            <div style={{margin: 20}}>
                                <Card style={{padding: 10, textAlign: "center", color: "white", background: "blue"}}>
                                    <Row>
                                        <Col sm={12} md={6} lg={6}>
                                            <FirebaseDatabaseProvider firebase={this.props.firebase}>
                                                <FirebaseDatabaseNode
                                                    path={"Users/" + "3Ztf647h7RVpf2HzQKdKJ9nMovn1" }>{data => {
                                                   console.log(data.path);
                                                    return(
                                                        <Dropdown>
                                                            ...
                                                            <Dropdown.Menu>
                                                                <Dropdown.Item href="#/action-1">{"Test: " +data.path}</Dropdown.Item>
